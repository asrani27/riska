...
<div class="wrapper">
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/bgg.jpg'); background-size:cover">
    <div class="container">
      ...
      <section class="content">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <img src="/logo/rri.png" width="40%" ><br/><br/>
            </div>
          <br/><br/>
            <div class="box box-success"style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);border-top-color: green">
              <div class="box-header with-border text-center">
                <h3 class="box-title">ARSIP DIGITAL </h3>
              ...
              <div class="box-footer social-auth-links">
                <button type="submit" class="btn btn-success btn-flat btn-block"><i class="fa fa-sign-in"></i> Masuk</button>
              </div>
              </form>
            </div>
          </div>
